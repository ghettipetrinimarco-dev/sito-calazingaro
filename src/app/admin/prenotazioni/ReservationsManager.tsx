            ...
            <div className="mt-6 grid gap-3">
              ...
              {visibleReservations.map((reservation) => {
                ...
                return (
                  ...
                  >
                    <div className="grid gap-4 xl:grid-cols-[92px_1fr_auto] xl:items-start">
                      ...
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className={`rounded-full border px-2.5 py-1 text-xs font-medium ${statusStyles[reservation.status]}`}>
                        ...
                        {isEditing ? (
                          <>
                            <button
                              type="button"
                              onClick={saveEditing}
                              className="inline-flex h-10 items-center gap-2 rounded-[8px] bg-[#26231f] px-3 text-sm font-semibold text-white"
                            >
                            ...
                            <button
                              ...
                              className="inline-flex h-10 items-center gap-2 rounded-[8px] border border-stone-200 px-3 text-sm font-semibold text-stone-600"
                            >
                              <X className="size-4" />
                              Annulla
                            </button>
                          ...
                          <>
                            {reservation.status !== "arrived" && (
                              <button
                                ...
                                className="inline-flex h-10 items-center gap-2 rounded-[8px] border border-emerald-200 bg-emerald-50 px-3 text-sm font-semibold text-emerald-800"
                              >
                            ...
                            <button
                              ...
                              className="inline-flex h-10 items-center gap-2 rounded-[8px] border border-stone-200 px-3 text-sm font-semibold text-stone-600 hover:border-stone-400"
                            >
