...
function getSeed(today: string): AdminReservation[] {
  ...
  return [
    ...
    // ─── Cena oggi (densità per Spuntalista) ─────────────────────────
    // Già arrivati / chiusi
    make({
      id: "seed-12",
      name: "Esposito",
      ...
      status: "arrived",
      table: "T1",
      notes: "ricorrenza, tavolo tranquillo",
      tags: ["anniversario"],
      source: "telefono",
    ...
    make({
      ...
      status: "arrived",
      table: "T9",
      notes: "due bambini + passeggino",
      tags: ["bambini", "passeggino"],
      source: "whatsapp",
    ...
    // In arrivo con allergie/preferenze (per mostrare pillola rossa)
    make({
      id: "seed-15",
      name: "Bianchi M.",
      date: today,
      ...
      status: "confirmed",
      table: "T4",
      notes: "allergia crostacei (capofamiglia)",
      tags: ["allergia"],
      source: "telefono",
    ...
    make({
      ...
      status: "confirmed",
      table: null,
      notes: "vista mare se possibile",
      tags: ["vegetariano", "vista-mare"],
      source: "telefono",
    ...
    make({
      ...
      status: "confirmed",
      table: "T8",
      notes: "compleanno 50 anni, torta a fine cena",
      tags: ["compleanno"],
      source: "manuale",
    ...
    make({
      ...
      status: "confirmed",
      table: "T3",
      notes: "allergia frutta secca grave (bimba)",
      tags: ["allergia", "bambini"],
      source: "whatsapp",
    ...
    make({
      ...
      status: "confirmed",
      table: "T7",
      notes: "tre bambini, due seggioloni",
      tags: ["bambini", "seggiolone"],
      source: "manuale",
    ...
    make({
      ...
      status: "confirmed",
      table: null,
      notes: "primo anniversario di matrimonio",
      tags: ["anniversario"],
      source: "whatsapp",
      createdAt: `${today}T12:30:00`,
    }),
